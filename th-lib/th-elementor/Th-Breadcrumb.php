...
class Th_Breadcrumb extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Breadcrumb', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'breadcrumb-default' => esc_html__( 'Default', 'coffeehouse' ),
					'breadcrumb-style2' => esc_html__( 'Style 2', 'coffeehouse' ),
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			'title_color_hover',
			[
				'label' => esc_html__( 'Text Color hover', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Core\Schemes\Color::get_type(),
					'value' => Core\Schemes\Color::COLOR_1,
		...
		$this->add_control(
			'blend_mode',
			[
				'label' => esc_html__( 'Blend Mode', 'coffeehouse' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Normal', 'coffeehouse' ),
					'multiply' => 'Multiply',
					'screen' => 'Screen',
					'overlay' => 'Overlay',
					'darken' => 'Darken',
