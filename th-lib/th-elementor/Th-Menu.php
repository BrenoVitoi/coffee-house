...
class Th_Menu extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
            'content_tab',
            [
                'label' => esc_html__('Menu settings', 'coffeehouse'),
        ...
        $this->add_control(
            'nav_menu',
            [
                'label'     =>esc_html__( 'Select menu', 'coffeehouse' ),
		...
		$this->add_control(
			'main_menu_style',
			[
				'label' => esc_html__( 'Menu style', 'coffeehouse' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => esc_html__( 'Default', 'coffeehouse' ),
					'icon' => esc_html__( 'Menu icon', 'coffeehouse' ),
				],
			]
		);
        ...
        $this->add_responsive_control(
			'main_menu_position',
			[
				'label' => esc_html__( 'Menu position', 'coffeehouse' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left'  => esc_html__( 'Left', 'coffeehouse' ),
					'center' => esc_html__( 'Center', 'coffeehouse' ),
                    'right' => esc_html__( 'Right', 'coffeehouse' ),
                    'justified'  => esc_html__( 'Justified', 'coffeehouse' ),
				],
				'selectors' => [
		...
		$this->start_controls_section(
            'content_side_tab',
            [
                'label' => esc_html__('Menu side/mobile', 'coffeehouse'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
		);
		...
		$this->add_control(
			'th_nav_menu_logo',
			[
				'label' => esc_html__( 'Choose Mobile Menu Logo', 'coffeehouse' ),
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Item text color', 'coffeehouse' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Head Padding', 'coffeehouse' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_section(
            'style_tab_menuitem',
            [
                'label' => esc_html__('Menu item style', 'coffeehouse'),
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'coffeehouse' ),
        ...
        $this->add_responsive_control(
			'menu_item_spacing',
			[
				'label' => esc_html__( 'Spacing', 'coffeehouse' ),
                'type' => Controls_Manager::DIMENSIONS,
		...
		$this->start_controls_tabs(
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background', 'coffeehouse' ),
					'types' => ['classic', 'gradient'],
					'selector' => '{{WRAPPER}} .th-navbar-nav > li > a',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (Active)', 'coffeehouse' ),
					'type' => Controls_Manager::COLOR,
					'devices' => [ 'desktop', 'tablet' ],
					'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Items Border', 'coffeehouse' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Last Child', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border First Child', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu item style', 'coffeehouse'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Submenu Indicator', 'coffeehouse' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'th_line_arrow',
				'options' => [
					'th_line_arrow'  => esc_html__( 'Line Arrow', 'coffeehouse' ),
					'th_plus_icon' => esc_html__( 'Plus', 'coffeehouse' ),
					'th_fill_arrow' => esc_html__( 'Fill Arrow', 'coffeehouse' ),
					'th_none' => esc_html__( 'None', 'coffeehouse' ),
                ],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator color', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'devices' => [ 'desktop', 'tablet' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator Margin', 'coffeehouse' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_tabs(
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (hover)', 'coffeehouse' ),
					'type' => Controls_Manager::COLOR,
					'devices' => [ 'desktop', 'tablet' ],
					'selectors' => [
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background (hover)', 'coffeehouse' ),
					'types' => [ 'classic', 'gradient' ],
					'selector' => '
			...
			$this->add_group_control(
				...
				[
					...
					'label' 	=> esc_html__( 'Item background (Active)', 'coffeehouse' ),
					'types'		=> ['classic', 'gradient'],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sub Menu Items Border', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu panel style', 'coffeehouse'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Panel Menu Border', 'coffeehouse' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Container background', 'coffeehouse' ),
                'types' => [ 'classic','gradient' ],
                'selector' => '{{WRAPPER}} .th-navbar-nav .sub-menu',
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container width', 'coffeehouse' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon menu Style', 'coffeehouse' ),
                'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Icon menu Toggle', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Position', 'coffeehouse' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Size height', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Humber Icon Color', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Close Toggle', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mobile Menu Logo', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		if($settings['nav_menu'] != '' && wp_get_nav_menu_items($settings['nav_menu']) !== false){
			...
			if(isset($settings['th_nav_menu_logo']['url']) && !empty($settings['th_nav_menu_logo']['url'])){
				$logo_mobile = 	'<a class="mobile-logo" href="'.home_url('/').'">
									<img src="'.$settings['th_nav_menu_logo']['url'].'" alt="'.esc_attr__("logo mobile","coffeehouse").'" >
								</a>';
			}
			...
			echo 	'<div class="th-menu-container th-menu-offcanvas-elements th-navbar-nav-default ' .$settings['style_tab_submenu_item_arrow'].' menu-style-'.$settings['main_menu_style'].' default-'.$settings['main_menu_style'].'">
						'.$icon_html.'
