...
class Th_Instagram extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Instagram', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-instagram-grid'		=> esc_html__( 'Grid', 'coffeehouse' ),
					'elth-instagram-slider'	=> esc_html__( 'Slider', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'media_from',
			[
				'label' 	=> esc_html__( 'Media from', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'username',
				'options'   => [
					'username'		=> esc_html__( 'Username', 'coffeehouse' ),
					'media-lib'		=> esc_html__( 'Media library', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'username', 
			[
				'label' => esc_html__( 'User name', 'coffeehouse' ),
		...
		$this->add_control(
			'token', 
			[
				'label' => esc_html__( 'Token', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			'number',
			[
				'label' => esc_html__( 'Photos number', 'coffeehouse' ),
		...
		$this->add_control(
			'photos_size',
			[
				'label' 	=> esc_html__( 'Image size', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => [
					'0'		=> esc_html__( 'Small', 'coffeehouse' ),
					'1'		=> esc_html__( 'Medium', 'coffeehouse' ),
					'2'		=> esc_html__( 'Large', 'coffeehouse' ),
				],
				'condition' => [
					'media_from' => 'username',
				]
		...
		$this->add_control(
			'text_hover', 
			[
				'label' => esc_html__( 'Text hover', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			'list_images',
			[
				'label' => esc_html__( 'Add images', 'coffeehouse' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_images->get_controls(),
				'title_field' => esc_html__( 'Item', 'coffeehouse' ),
				'condition' => [
		...
		$this->add_control(
			'color_icon',
			[
				'label' => esc_html__( 'Color icon', 'coffeehouse' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography text hover', 'coffeehouse' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background overlay', 'coffeehouse' ),
		...
		$this->add_responsive_control(
			'padding_wrap_item',
			[
				'label' => esc_html__( 'Padding wrap', 'coffeehouse' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
				'selectors' => [
	...
	protected function render() {
		...
		if ( $settings['style'] == 'elth-instagram-slider' ) {
			...
			$this->add_render_attribute( 'elth-wrapper', 'data-items', $settings['slider_items'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-items-tablet', $settings['slider_items_tablet'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-items-mobile', $settings['slider_items_mobile'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-space', $settings['slider_space'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-space-tablet', $settings['slider_space_tablet'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-space-mobile', $settings['slider_space_mobile'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-column', $settings['slider_column'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-loop', $settings['slider_loop'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-speed', $settings['slider_speed'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-navigation', $settings['slider_navigation'] );
			$this->add_render_attribute( 'elth-wrapper', 'data-pagination', $settings['slider_pagination'] );
