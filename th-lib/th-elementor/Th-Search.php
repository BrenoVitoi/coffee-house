...
class Th_Search extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Search form', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-search-default'		=> esc_html__( 'Default', 'coffeehouse' ),
					'elth-search-icon'  		=> esc_html__( 'Icon', 'coffeehouse' ),
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Search button', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Enter key to search', 'coffeehouse' ),
		...
		$this->add_control(
			'search_in',
			[
				'label'		=> esc_html__( 'Search in', 'coffeehouse' ),
				'type' 		=> Controls_Manager::SELECT,
				'default' 	=> 'product',
				'options'   => [
					'product'  => esc_html__( 'Product', 'coffeehouse' ),
					'post'     => esc_html__( 'Post', 'coffeehouse' ),
					'all'      => esc_html__( 'All', 'coffeehouse' ),
				],
			]
		);
		$this->add_control(
			'show_cat',
			[
				'label' => esc_html__( 'Show choose category', 'coffeehouse' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter slug categories. The values separated by ",". Example cat-1,cat-2. Default will show all categories', 'coffeehouse' ),
				'condition' => [
					'show_cat' => 'yes'
				]
			]
		...
		$this->add_control(
			'live_search',
			[
				'label' => esc_html__( 'Live search', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->start_controls_section(
			'section_icon_popup',
			[
				'label' => esc_html__( 'Icon - popup', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			'section_style_cat',
			[
				'label' => esc_html__( 'Categories dropdown', 'coffeehouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'All categories', 'coffeehouse' ),
				'placeholder' => esc_html__( 'Type your title here', 'coffeehouse' ),
			]
		);
		...
		$this->add_control(
			'title_cat_color',
			[
				'label' => esc_html__( 'Title Color', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background popup', 'coffeehouse' ),
			...
			<div class="elth-search-form-wrap">
				...
				<form class="elth-search-form <?php echo esc_attr($settings['align_form'])?>" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			        ...
			        <div class="elth-list-product-search">
			            <p class="text-center"><?php esc_html_e("Please enter key search to display results.","coffeehouse")?></p>
			        </div>
			    </form>
			</div>
		</div>
