...
class Th_Shop extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Shop', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'display',
			[
				'label' 	=> esc_html__( 'Display', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'elth-product-grid',
				'options'   => [
					'elth-product-grid'		=> esc_html__( 'Grid', 'coffeehouse' ),
					'elth-product-list'		=> esc_html__( 'List', 'coffeehouse' ),
				],
			]
		);
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' => esc_html__( 'Filter button', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
