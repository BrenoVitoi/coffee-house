...
class Th_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider', 'coffeehouse' );
	}
	...
	public function get_all_pages($post_type = 'wpcf7_contact_form') {
		global $post;
        $post_temp = $post;
        $page_list = array(''=>esc_html__("--Select one--","coffeehouse"));
        if(is_admin()){
	...
	public function get_slider_settings() {
		...
		$this->add_control(
			'slider_middle',
			[
				'label' => esc_html__( 'Middle', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_mousewheel',
			[
				'label' => esc_html__( 'Mousewheel', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_effects',
			[
				'label' 	=> esc_html__( 'Effects', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'coffeehouse' ),
					'fade'			=> esc_html__( 'Fade', 'coffeehouse' ),
					'coverflow'		=> esc_html__( 'Coverflow', 'coffeehouse' ),
					'flip'			=> esc_html__( 'Flip', 'coffeehouse' ),
					'cube'			=> esc_html__( 'cube', 'coffeehouse' ),
				],
			]
		);
	...
	public function get_slider_styles() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''  => esc_html__( 'Default', 'coffeehouse' ),
					'slider-nav-style2'  => esc_html__( 'Style 2', 'coffeehouse' ),
					'slider-nav-style3'  => esc_html__( 'Style 3', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''  => esc_html__( 'Default', 'coffeehouse' ),
					'slider-pag-style2'  => esc_html__( 'Style 2', 'coffeehouse' ),
					'slider-pag-style3'  => esc_html__( 'Style 3', 'coffeehouse' ),
					'slider-pag-style4'  => esc_html__( 'Style 4', 'coffeehouse' ),
				],
			]
		);
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					''		=> esc_html__( 'Default', 'coffeehouse' ),
					'megacontent'		=> esc_html__( 'Mega content', 'coffeehouse' ),
				],
			]
		);
		...
		$repeater_sliders->add_control(
			'title', 
			[
				'label' => esc_html__( 'Title/name', 'coffeehouse' ),
		...
		$repeater_sliders->add_control(
			'description', 
			[
				'label' => esc_html__( 'Description/position', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
			]
		...
		$repeater_sliders->add_control(
			...
			[
				...
				'rows' => 10,
				'default' => '',
				'placeholder' => esc_html__( 'Type your content here', 'coffeehouse' ),
			]
		);
		...
		$repeater_sliders->add_control(
			'button_text', 
			[
				'label' => esc_html__( 'Button Text', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => "",
				'placeholder' => esc_html__( 'Enter text' , 'coffeehouse' ),
				'label_block' => true,
			]
		);
		$repeater_sliders->add_control(
			'button_style',
			[
				'label' 	=> esc_html__( 'Button Style', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'coffeehouse' ),
		...
		$repeater_sliders->add_control(
			...
			[
				'label' => esc_html__( 'Overlay background', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'list_sliders',
			[
				'label' => esc_html__( 'Add slide item', 'coffeehouse' ),
		...
		$repeater_contents->add_control(
			'megapage',
			[
				'label' => esc_html__( 'Choose content', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
		...
		$this->add_control(
			'list_items',
			[
				'label' => esc_html__( 'Add mega item', 'coffeehouse' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_sliders->get_controls(),
				'title_field' => esc_html__( 'Page ID: {{{megapage}}}', 'coffeehouse' ),
				'condition' => [
					'style' => 'megacontent',
				]
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider box', 'coffeehouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content text', 'coffeehouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style!' => 'megacontent',
				]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content box', 'coffeehouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style!' => 'megacontent',
				]
		...
		$this->start_controls_section(
			'section_style_box',
			[
				'label' => esc_html__( 'Box item', 'coffeehouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
