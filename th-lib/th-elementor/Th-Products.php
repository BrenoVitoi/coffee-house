...
class Th_Products extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products', 'coffeehouse' );
	}
	...
	public function get_thumb_styles($key='thumb', $class="thumb-image") {
		...
		$this->add_control(
			$key.'_overlay',
			[
				'label' => esc_html__( 'Overlay', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'zoom-thumb'		=> esc_html__( 'Zoom', 'coffeehouse' ),
					'rotate-thumb'		=> esc_html__( 'Rotate', 'coffeehouse' ),
					'zoomout-thumb'		=> esc_html__( 'Zoom Out', 'coffeehouse'),
					'translate-thumb'	=> esc_html__( 'Translate', 'coffeehouse'),
				],
			]
		);
	...
	public function get_slider_settings() {
		$this->start_controls_section(
			'section_slider',
			[
				'label' => esc_html__( 'Slider', 'coffeehouse' ),
		...
		$this->add_responsive_control(
			'slider_items',
			[
				'label' => esc_html__( 'Items', 'coffeehouse' ),
		...
		$this->add_responsive_control(
			'slider_space',
			[
				'label' => esc_html__( 'Space(px)', 'coffeehouse' ),
				'description'	=> esc_html__( 'For example: 20', 'coffeehouse' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 200,
				'step' => 1,
		...
		$this->add_control(
			'slider_column',
			[
				'label' => esc_html__( 'Columns', 'coffeehouse' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 1,
				'max' => 10,
				'step' => 1,
		...
		$this->add_control(
			'slider_speed',
			[
				'label' => esc_html__( 'Speed(ms)', 'coffeehouse' ),
				'description'	=> esc_html__( 'For example: 3000 or 5000', 'coffeehouse' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 3000,
				'max' => 10000,
				'step' => 100,
		...
		$this->add_control(
			'slider_auto',
			[
				'label' => esc_html__( 'Auto width', 'coffeehouse' ),
		...
		$this->add_control(
			'slider_center',
			[
				'label' => esc_html__( 'Center', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_loop',
			[
				'label' => esc_html__( 'Loop', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_navigation',
			[
				'label' => esc_html__( 'Navigation', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'coffeehouse' ),
				'label_off' => esc_html__( 'Hide', 'coffeehouse' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'slider_pagination',
			[
				'label' => esc_html__( 'Pagination', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'coffeehouse' ),
				'label_off' => esc_html__( 'Hide', 'coffeehouse' ),
				'return_value' => 'yes',
	...
	public function get_box_settings($key='box-key',$class="box-class") {
		...
		$this->add_responsive_control(
			$key.'_padding_wrap',
			[
				'label' => esc_html__( 'Padding Column', 'coffeehouse' ),
				'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', ],
				'selectors' => [
	...
	public function get_slider_styles() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Navigation', 'coffeehouse' ),
		...
		$this->add_control(
			'slider_icon_next',
			[
				'label' => esc_html__( 'Icon next', 'coffeehouse' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
		...
		$this->add_control(
			'slider_icon_prev',
			[
				'label' => esc_html__( 'Icon prev', 'coffeehouse' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Pagination', 'coffeehouse' ),
				'tab' 	=> Controls_Manager::TAB_STYLE,
				'condition' => [
					'display' => 'elth-product-slider',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'none',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'coffeehouse' ),
				'description'	=> esc_html__( 'Active status', 'coffeehouse' ),
				'types' => [ 'classic', 'gradient', 'video' ],
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__( 'Layout', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'display',
			[
				'label' 	=> esc_html__( 'Display type (Layout)', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'elth-product-grid',
				'options'   => [
					'elth-product-grid'		=> esc_html__( 'Grid', 'coffeehouse' ),
					'elth-product-slider'		=> esc_html__( 'Slider', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'item_style',
			[
				'label' 	=> esc_html__( 'Item style', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					''		=> esc_html__( 'Style 1 - default', 'coffeehouse' ),
		...
		$this->add_control(
			'display_tab',
			[
				'label' => esc_html__( 'Display tab', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_thumbnail',
			[
				'label' => esc_html__( 'Thumbnail', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_quickview',
			[
				'label' => esc_html__( 'Quick View', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_price',
			[
				'label' => esc_html__( 'Price', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_rate',
			[
				'label' => esc_html__( 'Rate', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_posts',
			[
				'label' => esc_html__( 'Query', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'orderby',
			[
				'label' 	=> esc_html__( 'Order by', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'None', 'coffeehouse' ),
					'ID'		=> esc_html__( 'ID', 'coffeehouse' ),
					'author'	=> esc_html__( 'Author', 'coffeehouse' ),
					'title'		=> esc_html__( 'Title', 'coffeehouse' ),
					'name'		=> esc_html__( 'Name', 'coffeehouse' ),
					'date'		=> esc_html__( 'Date', 'coffeehouse' ),
					'modified'		=> esc_html__( 'Last Modified Date', 'coffeehouse' ),
					'parent'		=> esc_html__( 'Parent', 'coffeehouse' ),
					'post_views'		=> esc_html__( 'Post views', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'order',
			[
				'label' 	=> esc_html__( 'Order', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'DESC',
				'options'   => [
					'DESC'		=> esc_html__( 'DESC', 'coffeehouse' ),
					'ASC'		=> esc_html__( 'ASC', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'product_type',
			[
				'label' 	=> esc_html__( 'Product type', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					'' 				=> esc_html__('Default','coffeehouse'),
                    'trending' 		=> esc_html__('Trending','coffeehouse'),
                    'featured' 		=> esc_html__('Featured Products','coffeehouse'),
                    'bestsell' 		=> esc_html__('Best Sellers','coffeehouse'),
                    'onsale' 		=> esc_html__('On Sale','coffeehouse'),
                    'toprate' 		=> esc_html__('Top rate','coffeehouse'),
                    'mostview' 		=> esc_html__('Most view','coffeehouse'),
                    'menu_order' 	=> esc_html__('Menu order','coffeehouse'),
				],
			]
		);
		...
		$this->add_control(
			'custom_ids', 
			[
				'label' => esc_html__( 'Show by IDs', 'coffeehouse' ),
				'description' => esc_html__( 'Enter IDs list. The values separated by ",". Example 11,12', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '11,12', 'coffeehouse' ),
			]
		);
		...
		$this->add_control(
			'cats', 
			[
				'label' => esc_html__( 'Categories', 'coffeehouse' ),
				'description' => esc_html__( 'Enter slug categories. The values separated by ",". Example cat-1,cat-2. Default will show all categories', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'coffeehouse' ),
			]
		);
		...
		$this->start_controls_section(
			'section_grid',
			[
				'label' => esc_html__( 'Grid', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		$this->add_responsive_control(
			'column',
			[
				'label' => esc_html__( 'Column', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'grid_type',
			[
				'label' 	=> esc_html__( 'Grid type', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''				=> esc_html__( 'Default', 'coffeehouse' ),
					'grid-masonry'	=> esc_html__( 'Masonry', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'pagination',
			[
				'label' 	=> esc_html__( 'Grid pagination', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''				=> esc_html__( 'None', 'coffeehouse' ),
					'pagination'	=> esc_html__( 'Pagination', 'coffeehouse' ),
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' => esc_html__( 'Filter', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'filter-col'		=> esc_html__( 'Style 2', 'coffeehouse' ),
					'filter-col filter-col-list'	=> esc_html__( 'Style 3', 'coffeehouse' ),
				],
				'condition' => [
					'filter_show' => 'yes',
				]
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'filter-2-col'				=> esc_html__( '2 Column', 'coffeehouse' ),
					'filter-3-col'				=> esc_html__( '3 Column', 'coffeehouse' ),
					'filter-4-col'				=> esc_html__( '4 Column', 'coffeehouse' ),
				],
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Categories', 'coffeehouse' ),
				'description' => esc_html__( 'Enter slug categories. The values separated by ",". Example cat-1,cat-2', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'coffeehouse' ),
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->add_control(
			'filter_attr', 
			[
				'label' => esc_html__( 'Attributes', 'coffeehouse' ),
				'description' => esc_html__( 'Enter slug attributes. The values separated by ",". Example attribute-1,attribute-2', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'coffeehouse' ),
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->start_controls_section(
			'section_tab',
			[
				'label' => esc_html__( 'Tab', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display_tab' => 'yes',
				]
		...
		$repeater->add_control(
			'title', [
				'label' => esc_html__( 'Title', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab Title' , 'coffeehouse' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Add tab', 'coffeehouse' ),
		...
		$this->start_controls_section(
			'section_style_item',
			[
				'label' => esc_html__( 'Item', 'coffeehouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'section_style_info',
			[
				'label' => esc_html__( 'Info', 'coffeehouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'coffeehouse' ),
		...
		$this->add_control(
			'price_regular',
			[
				'label' => esc_html__( 'Regular', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			'price_sale',
			[
				'label' => esc_html__( 'Sale', 'coffeehouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'tab_item_width',
			[
				'label' => esc_html__( 'Item width', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'tab_item_height',
			[
				'label' => esc_html__( 'Item height', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'elth-item', 'class', 'item-product-wrap');
		if ( $view == 'slider' ) {
        ...
        if($display_tab == 'yes' && is_array($tabs) && count($tabs) >=1){
        	...
        	foreach ($tabs as $key => $tab) {
        		...
        		if($icon_pos != 'after-text' && $icon) $tab_title_html .= '<i class="'.$icon['value'].'"></i>';
