...
class Th_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Button', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'button_size',
			[
				'label' 	=> esc_html__( 'Button size', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'coffeehouse' ),
					'elth-bt-medium'		=> esc_html__( 'Medium', 'coffeehouse' ),
					'elth-bt-large'		=> esc_html__( 'Large', 'coffeehouse' ),
					'elth-bt-extra-large'		=> esc_html__( 'Extra Large', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'button_text', 
			[
				'label' => esc_html__( 'Text button', 'coffeehouse' ),
				'description' => esc_html__( 'Enter text of button', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default'   => esc_html__( 'Read more', 'coffeehouse' ),
				'placeholder' => esc_html__( 'Read more', 'coffeehouse' ),
			]
		);
