...
class Th_Box_Info extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Box Info', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header', 'coffeehouse' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Header', 'coffeehouse' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Title', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Title', 'coffeehouse' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Description', 'coffeehouse' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'form',
			[
				'label' 	=> esc_html__( 'Add form', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
		...
		$repeater_icons->add_responsive_control(
			'icon_space',
			[
				'label' => esc_html__( 'Icon Space', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$repeater_icons->add_responsive_control(
			'title_space',
			[
				'label' => esc_html__( 'Title Space', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$repeater_icons->add_responsive_control(
			'description_space',
			[
				'label' => esc_html__( 'Description Space', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_control(
			'list_icons',
			[
				'label' => esc_html__( 'Add icons', 'coffeehouse' ),
		...
		$this->add_control(
			'icon_style',
			[
				'label' 	=> esc_html__( 'Style icon', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Default', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'image_style',
			[
				'label' 	=> esc_html__( 'Style image', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Default', 'coffeehouse' ),
		...
		$this->add_control(
			'check_button',
			[
				'label' => esc_html__( 'Show button', 'coffeehouse' ),
		...
		$this->add_control(
			'check_submit',
			[
				'label' => esc_html__( 'Click submit form', 'coffeehouse' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'coffeehouse' ),
				'label_off' => esc_html__( 'Off', 'coffeehouse' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_style_wrap',
			[
				'label' => esc_html__( 'Wrap Box', 'coffeehouse' ),
