...
class Th_MiniCart extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Mini Cart', 'coffeehouse' );
	}
	...
	public function mini_cart() {
		if(class_exists("woocommerce")){
			...
			if ( ! \WC()->cart->is_empty() ) : ?>
			    ...
			    <div class="mini-cart-footer">
				    <div class="mini-cart-total clearfix">
				        <span class="pull-left"><?php esc_html_e( 'TOTAL', 'coffeehouse' ); ?></span>
			...
			<?php else : ?>
			    ...
			    <div class="mini-cart-empty"><?php esc_html_e( 'No products in the cart.', 'coffeehouse' ); ?></div>
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-cart-icon'		=> esc_html__( 'Icon', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'style_content',
			[
				'label' 	=> esc_html__( 'Content Style', 'coffeehouse' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'elth-mini-cart-dropdown',
				'options'   => [
					'elth-mini-cart-dropdown'		=> esc_html__( 'Icon', 'coffeehouse' ),
					'elth-mini-cart-side'		=> esc_html__( 'Side', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'show_price',
			[
				'label' => esc_html__( 'Show price', 'coffeehouse' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			'size_number',
			[
				'label' => esc_html__( 'Size number', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			'color_number',
			[
				'label' => esc_html__( 'Color number', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'pos_left_number',
			[
				'label' => esc_html__( 'Position left', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' , '%'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'pos_top_number',
			[
				'label' => esc_html__( 'Position top', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' , '%'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown/side', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title Typography', 'coffeehouse' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Footer side', 'coffeehouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style_content' => 'elth-mini-cart-side',
				]
		...
		$this->add_responsive_control(
			'footer_text_space',
			[
				'label' => esc_html__( 'Space text', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		if(class_exists("woocommerce")){
			...
			<div class="elth-mini-cart <?php echo esc_attr($settings['style'].' '.$settings['style_content'])?>">			
	            ...
	            <div class="mini-cart-content">
	            	<?php 
	            	$h_title = esc_html__('item','coffeehouse');
