...
class Th_LogoText extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Logo Text', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Add Your Heading Text Here', 'coffeehouse' ),
			]
		);
		...
		$this->add_control(
			'header_size',
			[
				'label' => esc_html__( 'HTML Tag', 'coffeehouse' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'inline-block' => [
						'title' => esc_html__( 'Inline Block', 'coffeehouse' ),
						'icon' => 'eicon-text-align-left',
					],
					'block' => [
						'title' => esc_html__( 'Block', 'coffeehouse' ),
						'icon' => 'eicon-text-align-center',
					],
				],
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'coffeehouse' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__( 'Default', 'coffeehouse' ),
					'stacked' => esc_html__( 'Stacked', 'coffeehouse' ),
					'framed' => esc_html__( 'Framed', 'coffeehouse' ),
				],
				'default' => 'default',
		...
		$this->add_control(
			'shape',
			[
				'label' => esc_html__( 'Shape', 'coffeehouse' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => esc_html__( 'Circle', 'coffeehouse' ),
					'square' => esc_html__( 'Square', 'coffeehouse' ),
				],
				'default' => 'circle',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_control(
			'primary_color',
			[
				'label' => esc_html__( 'Primary Color', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'secondary_color',
			[
				'label' => esc_html__( 'Secondary Color', 'coffeehouse' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_responsive_control(
			'rotate',
			[
				'label' => esc_html__( 'Rotate', 'coffeehouse' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'deg' ],
				'default' => [
					'size' => 0,
		...
		$this->add_control(
			'border_width',
			[
				'label' => esc_html__( 'Border Width', 'coffeehouse' ),
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
