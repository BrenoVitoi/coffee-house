...
class Th_Price_Table extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Price Table (7up)', 'coffeehouse' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'price-table-default'		=> esc_html__( 'Default', 'coffeehouse' ),
				],
			]
		);
		...
		$this->add_control(
			'duration',
			[
				'label' => esc_html__( 'Duration', 'coffeehouse' ),
				'type' => Controls_Manager::TEXT,
				'default'   => 'Per month',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Purchase' , 'coffeehouse' ),
			]
		);
