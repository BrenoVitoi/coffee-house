	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'coffeehouse' ); ?>">
					<option value=""><?php esc_html_e( 'Select Icon', 'coffeehouse' ); ?></option>
