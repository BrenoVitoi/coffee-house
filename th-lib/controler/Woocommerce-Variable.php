...
if(!class_exists('Th_Woocommerce_Attributes')){
    class Th_Woocommerce_Attributes{
        ...
        static function th_product_option_terms_attribute( $taxonomy, $index ) {
            $types = array(
                'color' => esc_html__( 'Color', 'coffeehouse' ),
                'image' => esc_html__( 'Image', 'coffeehouse' ),
            ...
            <select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select terms', 'coffeehouse' ); ?>" class="multiselect attribute_values wc-enhanced-select" name="attribute_values[<?php echo esc_attr($index); ?>][]">
                <?php
            ...
            <button class="button plus select_all_attributes"><?php esc_html_e( 'Select all', 'coffeehouse' ); ?></button>
            <button class="button minus select_no_attributes"><?php esc_html_e( 'Select none', 'coffeehouse' ); ?></button>
            <button class="button fr plus tawcvs_add_new_attribute" data-type="<?php echo esc_attr($taxonomy->attribute_type); ?>"><?php esc_html_e( 'Add new', 'coffeehouse' ); ?></button>
