...
else $title = esc_html__("Blog","coffeehouse");
if(is_archive()) $title = get_the_archive_title();
if(is_search()) $title = esc_html__("Search Result","coffeehouse");
            ...
            <ul class="sort-pagi-bar list-inline-block">
                ...
                <li>
                    <div class="elth-dropdown-box show-by">
                        <a href="#" class="dropdown-link"><span class="gray"><?php esc_html_e("Items:","coffeehouse")?> </span><span class="number"><?php echo esc_html((int)$number)?></span></a>
