...
<div class="filter-product <?php echo esc_attr($filter_style.' '.$filter_column.' '.$filter_pos)?>" data-load="<?php echo esc_attr($data_loadjs);?>" >
    <a href="#" class="btn-filter"><span class="color"><i class="la la-search"></i></span><?php esc_html_e("Filter","coffeehouse");?></a>
    <div class="box-attr-filter">
        ...
        ?>
            <div class="item-box-attr">
                <div class="item-attr-title">
                    <label><?php esc_html_e("Categories","coffeehouse");?></label>
                </div>
        ...
        if($filter_price == 'yes'){
            ...
            <div class="item-box-attr">
                <div class="item-attr-title">
                    <label><?php esc_html_e("Price","coffeehouse");?></label>
                </div>
                <div class="item-attr-content range-filter">
                    ...
                    <div class="attr-price-filter">
                        <p>
                            <label><?php esc_html_e("Filter By Price:","coffeehouse");?></label>
