...
if(!empty($main_color)){
    ...
    .woocommerce-MyAccount-navigation li.is-active a, .woocommerce-MyAccount-navigation li a:hover,.product-label > span.new,.tagcloud a,.mini-cart-number
    ...
    if(strpos($main_color, '#') > -1){
        ...
        $style .= '.bg-rgb,.menu-style-icon .th-menu-inner
