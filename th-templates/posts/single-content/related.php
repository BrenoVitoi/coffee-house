...
if($check_related == '1'):
    ...
    $title_df   = esc_html__("You might also like","coffeehouse");
    $title 		= th_get_option('post_single_related_title',$title_df);
    $number 	= th_get_option('post_single_related_number','6');
    $size 		= th_get_option('post_single_related_size','270x180');
    $itemres 	= th_get_option('post_single_related_item','0:1,480:2,990:3');
    ...
    <div class="th-block-detail single-related-post">
        ...
        $button_text = esc_html__("Read more", "coffeehouse");
