...
<?php
    ...
    <div id="header" class="header header-default">
        <div class="header-top-default">
            <div class="container">
                <div class="logo">
                    <a href="<?php echo esc_url(home_url('/'));?>" title="<?php echo esc_attr__("logo","coffeehouse");?>">
                        <?php $th_logo=th_get_option('logo');?>
                        <?php if($th_logo!=''){
                            echo '<h1 class="hidden">'.get_bloginfo('name', 'display').'</h1><img src="' . esc_url($th_logo) . '" alt="'.esc_attr__("logo","coffeehouse").'">';
